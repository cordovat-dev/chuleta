...
CREATE VIEW v_report_cache_age as select trunc((julianday(CURRENT_TIMESTAMP) -julianday(value))*24) AS AGE from settings where key = 'LAST_UPDATED_REPORT_CACHE'
